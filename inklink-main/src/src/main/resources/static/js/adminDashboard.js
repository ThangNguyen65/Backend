...
function addBook(){
	...
	if(erm.length!=0){
		...
		try{
			...
			showErrors("Thêm Sách. Sử dụng đúng kiểu số để xác định năm, giá xuất bản, chiều rộng và chiều cao của cuốn sách.");
		}	
	}
...
function saveEditBook(){
	...
	if(erm.length!=0){
		...
		try{
			...
			showErrors("Sử dụng đúng kiểu số để xác định năm, giá xuất bản, chiều rộng và chiều cao của cuốn sách.");
		}
	}
}
